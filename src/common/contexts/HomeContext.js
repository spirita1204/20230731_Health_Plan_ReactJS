    ...
    */
    ...
    return (
        <HomeContext.Provider
            // <HomeContext.Provider> 是用來提供 HomeContext 上下文的提供者。這是 React 中上下文的一種用法，它允許你將值傳遞給下層組件，而不必透過手動一層層地傳遞 props。
            value={{
                translate,
            }}
        >
